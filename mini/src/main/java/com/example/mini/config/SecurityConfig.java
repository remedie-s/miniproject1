	...
	SecurityFilterChain filterChain(HttpSecurity http) throws Exception{
		http
			.authorizeHttpRequests( ( a ) -> a.requestMatchers
					(new AntPathRequestMatcher("/spuser/**")).permitAll() )
			.authorizeHttpRequests( ( a ) -> a.requestMatchers
					(new AntPathRequestMatcher("/homepage/**")).permitAll() )
			.authorizeHttpRequests( ( a ) -> a.requestMatchers
					(new AntPathRequestMatcher("/product/upload/**")).hasAnyRole("SELLER","ADMIN") )
			.authorizeHttpRequests( ( a ) -> a.requestMatchers
					(new AntPathRequestMatcher("/qna/post/**")).permitAll() )
			.authorizeHttpRequests( ( a ) -> a.requestMatchers
					(new AntPathRequestMatcher("/qna/review/**")).hasAnyRole("SELLER","ADMIN") )
			.authorizeHttpRequests( ( a ) -> a.requestMatchers
					(new AntPathRequestMatcher("/product/**")).permitAll() )
			.authorizeHttpRequests( ( a ) -> a.requestMatchers
					(new AntPathRequestMatcher("/sporder/**")).permitAll() )
			.authorizeHttpRequests( ( a ) -> a.requestMatchers
